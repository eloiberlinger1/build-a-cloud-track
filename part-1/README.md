...
I could manually create the bootstrap bucket that stores the `.tfstate` but i saw it is also possible and good practice to use terraform to do this in a /bootstrap subfolder.
